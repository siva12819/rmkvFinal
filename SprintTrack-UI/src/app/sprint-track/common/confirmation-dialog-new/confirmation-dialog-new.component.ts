...
export class ConfirmationDialogNewComponent {
  public confirmMessage: string;
  public alertMessage: string;
  public componentName: string;

  constructor(
    public _dialogRef: MatDialogRef<ConfirmationDialogNewComponent>,
  ...
  openAlertDialog(value: string, componentName?: string) {
    this._dialogRef = this._matDialog.open(ConfirmationDialogNewComponent, {
